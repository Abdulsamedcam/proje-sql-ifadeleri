...
CREATE TABLE public.kullanici_yetkileri (
    kullanici_yetki_id integer NOT NULL,
    yetki_id integer,
    kullanici_id integer,
    group_id integer
);
...
--
-- Name: kullanici_yetkileri_kullanici_yetki_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.kullanici_yetkileri_kullanici_yetki_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.kullanici_yetkileri_kullanici_yetki_id_seq OWNER TO postgres;

--
-- Name: kullanici_yetkileri_kullanici_yetki_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.kullanici_yetkileri_kullanici_yetki_id_seq OWNED BY public.kullanici_yetkileri.kullanici_yetki_id;
...
--
-- Name: kullanici_yetkileri kullanici_yetki_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.kullanici_yetkileri ALTER COLUMN kullanici_yetki_id SET DEFAULT nextval('public.kullanici_yetkileri_kullanici_yetki_id_seq'::regclass);
...
INSERT INTO public.kisiler VALUES
	...
	(55, 'abdulsamed', 'çam ', 13, NULL, 3156, 'asdsa', '', '', '', '                                                                                                                                                                                                                                                               ', 'asdsad', 13215);
...
SELECT pg_catalog.setval('public.kisiler_kisi_id_seq', 56, true);
...
--
-- Name: kullanici_yetkileri_kullanici_yetki_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.kullanici_yetkileri_kullanici_yetki_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.yetkiler_yetki_id_seq', 3, true);
...
ALTER TABLE ONLY public.kullanici_yetkileri
    ADD CONSTRAINT kullanici_yetkileri_pkey PRIMARY KEY (kullanici_yetki_id);
